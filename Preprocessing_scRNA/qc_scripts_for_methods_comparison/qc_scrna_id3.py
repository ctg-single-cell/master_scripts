# This script outputs qc metrics for: 3_Allen_MTG_Human_2022
...
def main():
    # initialize
    id = "3_Allen_MTG_Human_2022" #change here per data
    base_dir = "/gpfs/work5/0/vusr0480/Preprocessing_scRNA/data" #change here if necessary
    h5ad_path = os.path.join(base_dir, id, "Reference_MTG_RNAseq_all-nuclei.2022-06-07.h5ad") #change here per data
